function [ AXISlims, TESTdat] = phase_2_run_whitespace( Campaign, CTD, buttonMC, TESTdat, CtdCorrDataFile, depNUM_glider )
...
elseif WHITESPACE_SECTIONS == 1
    ...
    if PROFILE_DIR_SECTIONS == 0
        ...
        idxToProcess = glider_load_sections_idx();
...
TSdiags_from_Struct(1,1,TESTdat,depNUM_glider, CtdCorrDataFile, CTD)
