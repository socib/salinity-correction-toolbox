function [guess, value, iterations] = optim3steps_john(init_guess, step_major, step_minor, step_miniscule, max_iterations, varargin)
%
%
...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  guess = init_guess;
  value = imageArea_V2(guess, varargin{:});
  step = step_major;
  ...
  for iterations = 1:max_iterations
      ...
      next_value = imageArea_V2(next_guess, varargin{:});
