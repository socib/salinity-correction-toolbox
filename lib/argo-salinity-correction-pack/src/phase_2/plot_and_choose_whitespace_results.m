...
global MainPath
    ...
    % (ARGO) data as a result of the three different initial_guess values in
    ...
    switch MainPath.correctionMethod 
        case 'salinity_ARGO'
    ...
    switch MainPath.correctionMethod 
        ...
        case 'salinity_argo'
            ...
            TESTdat.Corr.S  = gsw_SP_from_C(TESTdat.Corr.C,TESTdat.T,TESTdat.Pr);
